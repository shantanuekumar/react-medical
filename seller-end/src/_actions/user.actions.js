...
function upload(product){
    ...
    return dispatch => {
        ...
        userService.upload(product)
        .then(
            product => {
                dispatch(success());
                history.push('/');
                dispatch(alertActions.success("product uploaded"));
            },
            error=> {
                dispatch(failure(error));
                dispatch(alertActions.error(error));
    ...
    function request(product) { return {type: userConstants.UPLOAD_REQUEST , product}}
    function success(product) { return {type: userConstants.UPLOAD_SUCCESS , product}}
